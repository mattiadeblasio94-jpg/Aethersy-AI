...
// Telegram Bot: @Lara_Aethersy_AI_bot
...
<div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0f; color: #f1f5f9; padding: 40px; border-radius: 16px;">
  ...
  <p style="color: #475569; font-size: 13px; margin-top: 32px;">Aethersy-AI · Lara AGENTE AI Aethersy · <a href="https://t.me/Lara_Aethersy_AI_bot" style="color: #38bdf8;">@Lara_Aethersy_AI_bot</a></p>
</div>`,
  });
}
