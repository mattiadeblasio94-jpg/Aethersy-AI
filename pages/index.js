...
const TOOLS = [
  { icon: '🔍', title: 'Ricerca Web AI', desc: 'Ricerca su internet in tempo reale con sintesi AI e citazioni verificate.', route: '/dashboard' },
  { icon: '💬', title: 'Chat Intelligente', desc: 'Conversa con Lara AI con memoria persistente e contesto multi-sessione.', route: '/dashboard' },
  { icon: '⚡', title: 'Generatore Codice', desc: 'Crea app, script, API e automazioni in 15+ linguaggi.', route: '/terminal' },
  { icon: '📋', title: 'Business Plan AI', desc: 'Business plan completo con fasi, KPI, timeline e proiezioni.', route: '/dashboard' },
  { icon: '💰', title: 'Strategie Monetizzazione', desc: 'Funnel, pricing strategy, ads, ROAS e scaling per ogni nicchia.', route: '/dashboard' },
  { icon: '📧', title: 'Email Marketing AI', desc: 'Scrivi, personalizza e invia campagne email. Sequenze automatiche.', route: '/dashboard' },
  { icon: '🔄', title: 'Funnel Builder AI', desc: 'Crea funnel di vendita completi con landing e automazioni.', route: '/dashboard' },
  { icon: '💼', title: 'Trova Lavori Freelance', desc: 'Cerca opportunità freelance su Upwork, Freelancer, LinkedIn.', route: '/dashboard' },
  { icon: '📝', title: 'Generatore Contratti', desc: 'Crea contratti professionali, preventivi e fatture.', route: '/dashboard' },
  { icon: '📈', title: 'Finanza & Crypto Live', desc: 'Dati di borsa e crypto in tempo reale. Analisi tecnica AI.', route: '/dashboard' },
  { icon: '🧠', title: 'Cervello AI (Wiki)', desc: 'Carica documenti, PDF, immagini. L\'AI impara dai tuoi file.', route: '/wiki' },
  { icon: '🖥️', title: 'Terminale AI', desc: '500+ template per ogni settore. Genera ed esegui codice.', route: '/terminal' },
  { icon: '🏗️', title: 'Builder AI', desc: 'Costruisci app full-stack conversando con l\'AI.', route: '/builder' },
  { icon: '🎬', title: 'Cinema Studio', desc: 'Genera video cinematici con AI. Modelli Wan 2.1 e LTX Video.', route: '/cinema' },
  { icon: '🔗', title: 'SEO & Content AI', desc: 'Analisi SEO on-page, keyword research, articoli ottimizzati.', route: '/dashboard' },
  { icon: '📱', title: 'Social Media AI', desc: 'Genera post, reel, hashtag e calendario editoriale.', route: '/dashboard' },
  { icon: '👥', title: 'CRM & Lead Management', desc: 'Gestisci prospect, pipeline e scoring lead con AI.', route: '/admin' },
  { icon: '📄', title: 'Invoice & Preventivi', desc: 'Genera fatture e preventivi. Export PDF e tracciamento.', route: '/dashboard' },
  { icon: '🤖', title: 'Bot Telegram AI', desc: 'Controlla tutto da Telegram. Ricerche, codice, email, dati.', route: '/lara' },
  { icon: '🔬', title: 'Ricerca Profonda', desc: 'Deep research con scraping multi-pagina e paper accademici.', route: '/dashboard' },
  { icon: '⚙️', title: 'Automazioni AI', desc: 'Crea workflow automatici 24/7. Integra API e webhook.', route: '/dashboard' },
  { icon: '📊', title: 'Analytics & Report', desc: 'Dashboard dati, KPI tracking, report automatici.', route: '/admin' },
];
...
const STEPS = [
  ...
  { num: '02', icon: '⚡', title: 'Scegli i tuoi strumenti', desc: 'Accedi alla dashboard. Scegli tra 22+ strumenti AI: Builder, Cinema Studio, ricerca, email, codice, finanza e molto altro.' },
    ...
    <div style={{ minHeight: '100vh', background: '#060611', color: '#fff', fontFamily: "'Inter', system-ui, sans-serif", overflowX: 'hidden' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Toolbar Styles */
        .toolbar { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.5rem 2.5rem', background: 'rgba(6,6,17,0.98)', borderBottom: '1px solid rgba(124,58,237,0.25)', position: 'sticky', top: 0, zIndex: 101, backdropFilter: 'blur(20px)' }
        .toolbarLeft { display: 'flex', alignItems: 'center', gap: '0.75rem' }
        .toolbarRight { display: 'flex', alignItems: 'center', gap: '0.75rem' }
        .toolLink { display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '0.45rem 0.75rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 8, color: '#94a3b8', fontSize: '0.8rem', fontWeight: 500, cursor: 'pointer', transition: 'all 0.2s', textDecoration: 'none' }
        .toolLink:hover { background: 'rgba(124,58,237,0.15)', borderColor: 'rgba(124,58,237,0.4)', color: '#a78bfa' }
        .toolLink.primary { background: 'linear-gradient(135deg, rgba(124,58,237,0.2), rgba(6,182,212,0.15))', borderColor: 'rgba(124,58,237,0.4)', color: '#a78bfa' }
        .toolLink.primary:hover { background: 'linear-gradient(135deg, rgba(124,58,237,0.3), rgba(6,182,212,0.25))' }
        .divider { width: 1px, height: 20, background: 'rgba(255,255,255,0.1)' }
        .settingsBtn { display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '0.45rem 0.75rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 8, color: '#94a3b8', fontSize: '0.8rem', cursor: 'pointer', transition: 'all 0.2s' }
      ...
      <div className="toolbar">
        <div className="toolbarLeft">
          <Link href="/builder" className="toolLink primary">
            🏗️ Builder
          </Link>
          <Link href="/terminal" className="toolLink">
            🖥️ Terminal
          </Link>
          <Link href="/cinema" className="toolLink">
            🎬 Cinema
          </Link>
          <Link href="/dashboard" className="toolLink">
            💬 Chat AI
          </Link>
          <Link href="/lara" className="toolLink">
            🤖 Lara Bot
          </Link>
        </div>
        <div className="toolbarRight">
          ...
          <Link href="/wiki" className="toolLink">
            🧠 Wiki
          </Link>
              ...
              <div className="dropdownMenu">
                ...
                {user && (
                  <div className="userPanel">
                    ...
                    <Link href="/admin" className="panelBtn">📈 Analytics</Link>
      ...
      <section style={{ textAlign: 'center', padding: '7rem 2rem 5rem', position: 'relative', overflow: 'hidden', minHeight: '85vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 800, margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(124,58,237,0.12)', border: '1px solid rgba(124,58,237,0.3)', color: '#a78bfa', padding: '0.4rem 1.2rem', borderRadius: 100, fontSize: '0.8rem', fontWeight: 600, marginBottom: '2rem' }}>
            🤖 22+ Strumenti AI · Builder & Cinema Studio inclusi
          </div>
      ...
      <div style={{ background: 'rgba(255,255,255,0.02)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '2.5rem 2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'center', gap: '5rem', flexWrap: 'wrap', maxWidth: 900, margin: '0 auto' }}>
          {[
            { num: '22+', label: 'Strumenti AI integrati' },
      ...
      <section id="tools" style={{ padding: '5rem 2rem', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '1.05rem', maxWidth: 500, margin: '0 auto' }}>
            Builder AI, Cinema Studio, ricerca web, email, codice, finanza e altro. Strumenti reali per il lavoro quotidiano.
          </p>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '1rem' }}>
          {TOOLS.map(t => (
            <div key={t.title} className="tool-card" onClick={() => {
              if (user) router.push(t.route || '/dashboard');
              else { setTab('register'); setModal(true); }
            }}>
